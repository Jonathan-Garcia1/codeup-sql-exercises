#1 Find all employees with first names 'Irena', 'Vidya', or 'Maya', and order your results returned by first name. 
...
#F Irena Reutenauer / L Vidya Simmen
...
#Find all employees with first names 'Irena', 'Vidya', or 'Maya', and order your results returned by last name 
#and then first name. In your comments, answer: What was the first and last name in the first row of the results? 
#What was the first and last name of the last person in the table
# Irena Acton, Zyda Maya
SELECT *
FROM employees
WHERE first_name IN ('Irena' , 'Vidya' , 'Maya') 
